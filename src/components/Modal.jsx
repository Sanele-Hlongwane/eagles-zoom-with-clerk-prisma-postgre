...
const Modal = ({ isOpen, onClose, title, type, buttonLabel }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose} className="text-gray-100">
      <DialogContent className="gap-y-5 bg-gray-800"> {/* Set the background color here */}
        <DialogHeader>
        ...
        {type === "joiningMeeting" && (
          <div className="text-gray-100">
            ...
            <Input
              type="link"
              id="link"
              className="mb-5 mt-3 text-gray-900"
              onChange={(e) => {
        ...
        <Button
          onClick={handler}
          className={cn("text-gray-900 bg-yellow-500 hover:bg-yellow-600", {
